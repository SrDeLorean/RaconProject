            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
              ...
              <div className="lg:col-span-1 space-y-4">
                ...
                <div className="flex items-center gap-3 pt-1">
                  <a href="https://discord.gg/torneosprofc" target="_blank" rel="noreferrer" className="w-9 h-9 rounded-lg border border-border/40 bg-muted/20 flex items-center justify-center text-muted-foreground hover:text-[#5865F2] hover:border-[#5865F2]/40 hover:bg-[#5865F2]/10 hover:shadow-[0_0_15px_rgba(88,101,242,0.2)] transition-all duration-300" title="Discord">
                  ...
                  <a href="https://instagram.com/torneosprofc" target="_blank" rel="noreferrer" className="w-9 h-9 rounded-lg border border-border/40 bg-muted/20 flex items-center justify-center text-muted-foreground hover:text-[#E4405F] hover:border-[#E4405F]/40 hover:bg-[#E4405F]/10 hover:shadow-[0_0_15px_rgba(228,64,95,0.2)] transition-all duration-300" title="Instagram">
