      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 border-b border-border/50 pb-6">
          <div>
            <div className="flex items-center gap-3 mb-1">
              ...
              <Badge variant="neutral" className="uppercase">{competencia.estado}</Badge>
              <Badge variant="brand" className="uppercase font-mono">{cuposActuales}/{maxCupos} Cupos</Badge>
            </div>
        ...
        <div className="flex gap-2 bg-muted/30 p-1.5 rounded-lg border border-border/40 w-fit">
          <button 
            ...
            className={`px-4 py-2 rounded-md text-xs font-bold transition-colors ${activeTab === 'roster' ? 'bg-background text-foreground shadow-sm' : 'text-muted-foreground hover:text-foreground'}`}
          >
            👥 Roster de Equipos
          </button>
          <button 
            onClick={() => setActiveTab('calendario')}
            className={`px-4 py-2 rounded-md text-xs font-bold transition-colors ${activeTab === 'calendario' ? 'bg-background text-foreground shadow-sm' : 'text-muted-foreground hover:text-foreground'}`}
          >
