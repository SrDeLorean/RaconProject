  ...
  return (
    ...
    >
      <form className="flex flex-col gap-6 pt-2 pb-8" onSubmit={(e) => e.preventDefault()}>
        ...
        {/* IDENTIDAD */}
        <div className="space-y-4">
          <h3 className="text-xs font-bold text-muted-foreground uppercase tracking-widest border-b border-border/50 pb-1.5">Identidad Deportiva</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Input label="Nombre de División *" placeholder="Ej. Liga Elite" value={formData.nombre} onChange={(e) => setFormData({ ...formData, nombre: e.target.value })} error={formErrors?.nombre?.[0]} disabled={isSaving} required />
        ...
        {/* FECHAS */}
        <div className="space-y-4">
          <h3 className="text-xs font-bold text-muted-foreground uppercase tracking-widest border-b border-border/50 pb-1.5">Calendario Estricto</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
