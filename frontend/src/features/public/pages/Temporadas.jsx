                  ...
                  <Card key={ds.id} className="border border-border/50 bg-card/25 backdrop-blur-md p-6 relative overflow-hidden flex flex-col justify-between" withGlow>
                    ...
                    <div className="mt-5 relative z-10">
                      <Button 
                        ...
                        className="w-full h-10 text-[10px] font-condensed font-black uppercase tracking-widest bg-primary/10 text-primary border border-primary/20 hover:bg-primary hover:text-primary-foreground transition-all duration-300"
                      >
                        📊 Ficha & Calendario
                      </Button>
                    </div>
