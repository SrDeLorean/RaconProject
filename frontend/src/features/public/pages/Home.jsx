...
export default function Home() {
  return (
    <div className="relative min-h-screen bg-black text-foreground overflow-hidden font-sans flex flex-col md:flex-row">
      
      {/* Background Video Cinematográfico Global */}
      <div className="absolute inset-0 z-0 pointer-events-none">
        <iframe 
          className="w-[150vw] h-[150vh] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 opacity-30 mix-blend-screen grayscale-[30%]"
      ...
      >
        ...
        <div className="relative z-10 text-center p-8 transform group-hover:-translate-y-4 transition-transform duration-700">
          ...
          <h2 className="text-6xl md:text-8xl font-display font-black uppercase tracking-tighter text-white drop-shadow-2xl">
            11<span className="text-red-500">v</span>11
          </h2>
          <h3 className="text-2xl md:text-3xl font-display font-black uppercase tracking-widest text-white/90 mt-2 mb-6">
            CLUBES PRO
          </h3>
          <p className="text-sm md:text-base text-white/70 max-w-sm mx-auto font-light leading-relaxed">
            Gestión total de plantillas, ligas, mercado de fichajes y telemetría avanzada para tu comunidad competitiva.
          </p>
          <div className="mt-8 flex justify-center">
            <div className="px-8 py-3 rounded border border-red-500/50 text-white font-condensed font-black tracking-widest text-xs uppercase group-hover:bg-red-600 transition-colors duration-500 shadow-[0_0_20px_rgba(232,0,29,0)] group-hover:shadow-[0_0_30px_rgba(232,0,29,0.4)]">
      ...
      >
        ...
        <div className="relative z-10 text-center p-8 transform group-hover:-translate-y-4 transition-transform duration-700">
          ...
          <h2 className="text-6xl md:text-8xl font-display font-black uppercase tracking-tighter text-white drop-shadow-2xl flex items-center justify-center gap-2">
            1<span className="text-blue-500">v</span>1 <span className="text-white/30 font-light text-4xl">/</span> 2<span className="text-blue-500">v</span>2
          </h2>
          <h3 className="text-2xl md:text-3xl font-display font-black uppercase tracking-widest text-white/90 mt-2 mb-6">
            ULTIMATE TEAM
          </h3>
          ...
          <div className="mt-8 flex justify-center">
            <div className="px-8 py-3 rounded border border-blue-500/50 text-white font-condensed font-black tracking-widest text-xs uppercase group-hover:bg-blue-600 transition-colors duration-500 shadow-[0_0_20px_rgba(59,130,246,0)] group-hover:shadow-[0_0_30px_rgba(59,130,246,0.4)]">
              Ingresar al Hub UT
            </div>
          </div>
        </div>
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20 pointer-events-none hidden md:flex flex-col items-center justify-center">
        <div className="w-24 h-24 rounded-full bg-background border-4 border-border/50 flex items-center justify-center shadow-2xl backdrop-blur-md">
          <span className="font-display font-black text-2xl tracking-tighter bg-clip-text text-transparent bg-gradient-to-br from-white to-white/50">
            VS
          </span>
        </div>
      </div>
