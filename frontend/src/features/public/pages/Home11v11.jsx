        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
          {['PS5', 'XBOX SERIES X|S', 'PC', 'PS4'].map((plat, idx) => (
            <div key={idx} className="glass-card-hover p-8 text-center neon-glow" style={{ animationDelay: `${idx * 0.1}s` }}>
              ...
              <p className="text-xs text-red-100/50 mt-2 uppercase tracking-widest">Divisiones Activas</p>
            </div>
          ))}
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-red-100/60 font-sans text-sm">Olvídate de capturas de pantalla mediocres. Nuestro sistema actualiza Tablas de Posiciones, Goleadores y Asistencias en tiempo real.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-full bg-red-600/20 border border-red-500/50 flex items-center justify-center shrink-0 shadow-[0_0_15px_rgba(232,0,29,0.4)]">
                  ...
                  <div>
                    ...
                    <p className="text-red-100/60 font-sans text-sm">Filtra stats avanzadas por GK, DEF, MED y DEL. Demuestra tu valor en el mercado con datos duros: atajadas, pases clave y ratio de conversión.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-full bg-red-600/20 border border-red-500/50 flex items-center justify-center shrink-0 shadow-[0_0_15px_rgba(232,0,29,0.4)]">
                  ...
                  <div>
                    ...
                    <p className="text-red-100/60 font-sans text-sm">¿Eres agente libre? Publica tu perfil. ¿Capitán? Haz ofertas formales a las promesas de la liga y roba los talentos del rival.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative animate-scanline group">
               ...
               <div className="relative bg-[#111] border border-red-500/30 p-8 rounded-2xl shadow-[0_0_50px_rgba(232,0,29,0.2)] transform group-hover:scale-105 transition-transform duration-500">
                  ...
                  <h3 className="font-display text-5xl text-white tracking-widest">MAPACHE_99</h3>
                  <div className="grid grid-cols-2 gap-4 mt-6">
                    <div className="bg-black border border-red-500/20 p-4 rounded-lg text-center">
                      <span className="text-red-500 font-condensed text-xs block">GOLES</span>
                      <span className="text-4xl font-display font-black text-white">24</span>
                    </div>
                    <div className="bg-black border border-red-500/20 p-4 rounded-lg text-center">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 mt-12 animate-drum-roll" style={{ animationDelay: '0.4s' }}>
          <div className="flex flex-col md:flex-row justify-between items-end mb-8 border-b border-red-500/20 pb-4">
            <div>
              ...
              <p className="text-red-100/50 font-condensed tracking-widest mt-2 text-sm">HUD TÁCTICO ACTIVO // MONITOREANDO SERVIDORES</p>
            </div>
            ...
            {liveMatches.length > 0 ? liveMatches.map((match) => (
              <div key={match.id} className="glass-card-hover p-6 flex justify-between items-center border border-red-500/30 bg-black/80 relative overflow-hidden">
                ...
                <div className="text-center w-[40%]">
                  <span className="font-display text-2xl text-white truncate block">{match.home}</span>
                </div>
                ...
                <div className="text-center w-[40%]">
                  <span className="font-display text-2xl text-white truncate block">{match.away}</span>
                </div>
              </div>
            )) : (
