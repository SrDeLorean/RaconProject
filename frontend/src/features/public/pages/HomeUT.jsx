...
export default function HomeUT() {
  ...
  return (
    <div className="relative min-h-screen bg-black text-white overflow-hidden font-sans selection:bg-red-600 selection:text-white">
      ...
      <section className="relative min-h-[90vh] flex flex-col justify-center items-center px-6 text-center animate-drum-roll pt-20 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <iframe 
            className="w-[150vw] h-[150vh] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 pointer-events-none opacity-30 mix-blend-screen grayscale-[30%]"
        ...
        <div className="relative z-20 flex flex-col items-center">
          ...
          <h1 className="text-6xl md:text-8xl lg:text-9xl font-display font-black uppercase text-white tracking-tighter leading-[0.85] mb-6 drop-shadow-[0_0_30px_rgba(232,0,29,0.5)]">
            CONVIÉRTETE EN <br /><span className="text-red-500 neon-glow">LEYENDA</span> DE FUT
          </h1>
        <h2 className="text-xl md:text-2xl text-red-100/70 max-w-3xl font-light mb-10 font-sans">
        ...
        <div className="flex flex-col sm:flex-row gap-6 mt-4">
          ...
          <Link to="/contact" className="glass-card-hover px-10 py-4 text-white font-bold uppercase tracking-widest rounded-md text-sm flex items-center justify-center border border-red-500/30">
            VER RÁNKING GLOBAL
          </Link>
        </div>
        </div>
      ...
      <section className="relative z-10 py-24 px-6 md:px-12 bg-black/60 backdrop-blur-md border-y border-red-500/20">
        <div className="max-w-6xl mx-auto text-center mb-16 animate-drum-roll" style={{ animationDelay: '0.2s' }}>
          ...
          <p className="text-red-100/60 mt-4 max-w-2xl mx-auto font-sans">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
          {['PS5', 'XBOX SERIES X|S', 'PC', 'CROSSPLAY'].map((plat, idx) => (
            <div key={idx} className="glass-card-hover p-8 text-center neon-glow" style={{ animationDelay: `${idx * 0.1}s` }}>
              ...
              <p className="text-xs text-red-100/50 mt-2 uppercase tracking-widest">Ligas Competitivas</p>
            </div>
          ))}
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="animate-drum-roll" style={{ animationDelay: '0.3s' }}>
              <h2 className="text-5xl md:text-7xl font-display font-black text-white uppercase tracking-tight leading-[0.9] mb-8">
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-red-100/60 font-sans text-sm">Nuestro sistema de Elo te empareja con rivales de tu nivel. Sube tu MMR aplastando a la competencia y alcanza el Rango Élite.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-full bg-red-600/20 border border-red-500/50 flex items-center justify-center shrink-0 shadow-[0_0_15px_rgba(232,0,29,0.4)]">
                  ...
                  <div>
                    ...
                    <p className="text-red-100/60 font-sans text-sm">Guarda un registro detallado de tus Victorias/Derrotas, racha de partidos y promedio de goles. Construye un currículum que imponga respeto.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-full bg-red-600/20 border border-red-500/50 flex items-center justify-center shrink-0 shadow-[0_0_15px_rgba(232,0,29,0.4)]">
                  ...
                  <div>
                    ...
                    <p className="text-red-100/60 font-sans text-sm">Gana torneos relámpago y ligas de temporada para desbloquear premios exclusivos, insignias de perfil y el reconocimiento de toda la comunidad.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative animate-scanline group perspective-1000">
               ...
               <div className="relative w-full max-w-[350px] mx-auto bg-gradient-to-b from-[#111] to-black border-2 border-red-500/30 p-8 rounded-t-[30px] rounded-b-[40%] shadow-[0_0_50px_rgba(232,0,29,0.3)] transform group-hover:scale-105 group-hover:rotate-y-6 transition-all duration-500 overflow-hidden text-center">
                  <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-10 pointer-events-none" />
                  <div className="absolute top-0 right-0 w-32 h-32 bg-red-500/10 rounded-full blur-2xl pointer-events-none" />
                  
                  <div className="absolute top-6 left-6 text-left">
                    <span className="font-display text-5xl font-black text-white block leading-none drop-shadow-[0_0_10px_rgba(255,255,255,0.5)]">99</span>
                    <span className="text-xs font-condensed font-black tracking-widest text-red-500 uppercase">ÉLITE</span>
                  </div>
                  
                  <div className="w-28 h-28 mx-auto mt-4 rounded-full bg-gradient-to-br from-red-600 to-[#111] border-2 border-red-500 flex items-center justify-center font-display font-black text-4xl text-white shadow-[0_0_20px_rgba(232,0,29,0.5)] z-10 relative">
                    PRO
                  </div>
                  
                  <h3 className="text-3xl font-display font-black text-white tracking-widest uppercase mt-6 z-10 relative drop-shadow-[0_0_5px_rgba(255,255,255,0.3)]">xX_GamerPro_Xx</h3>
                  <div className="w-full h-px bg-gradient-to-r from-transparent via-red-500/50 to-transparent my-4" />
                  
                  <div className="grid grid-cols-2 gap-x-6 gap-y-3 text-xs font-condensed tracking-widest uppercase text-white/80 z-10 relative w-4/5 mx-auto">
      ...
      <section className="relative z-10 py-16 bg-[#0a0a0a] border-y border-red-500/30 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 mt-12 animate-drum-roll" style={{ animationDelay: '0.4s' }}>
          <div className="flex flex-col md:flex-row justify-between items-end mb-8 border-b border-red-500/20 pb-4">
            <div>
              ...
              <p className="text-red-100/50 font-condensed tracking-widest mt-2 text-sm">HUD COMPETITIVO // PARTIDOS 1V1 EN CURSO</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {liveMatches.length > 0 ? liveMatches.map((match) => (
              <div key={match.id} className="glass-card-hover p-6 flex justify-between items-center border border-red-500/30 bg-black/80 relative overflow-hidden">
                <div className="absolute top-0 left-0 w-1 h-full bg-red-500" />
                <div className="text-center w-[40%]">
                  <span className="font-display text-xl md:text-2xl text-white truncate block">{match.home}</span>
                </div>
                <div className="text-center w-[20%] flex flex-col items-center">
                  ...
                  <div className="bg-red-600/20 border border-red-500/50 px-4 py-2 rounded text-2xl font-display font-black text-white shadow-[0_0_10px_rgba(232,0,29,0.3)]">
                    {match.score}
                  </div>
                </div>
                <div className="text-center w-[40%]">
                  <span className="font-display text-xl md:text-2xl text-white truncate block">{match.away}</span>
                </div>
              </div>
            )) : (
      ...
      <section className="relative z-10 py-32 px-6 text-center animate-drum-roll" style={{ animationDelay: '0.6s' }}>
        ...
        <div className="relative z-10">
          <h2 className="text-5xl md:text-8xl font-display font-black text-white uppercase tracking-tighter leading-none mb-6">
            LLEGÓ TU HORA DE <br /><span className="text-red-500">HACER HISTORIA</span>
          </h2>
          <p className="text-red-100/70 font-sans max-w-2xl mx-auto mb-10 text-lg">
